...
class _AvatarGlowState extends State<AvatarGlow> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(AvatarGlow oldWidget) {
    ...
    if (widget.duration != oldWidget.duration || widget.curve != oldWidget.curve || widget.endRadius != oldWidget.endRadius) {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, widgetChild) {
        final decoration = BoxDecoration(
          ...
          color: widget.glowColor.withOpacity(alphaAnimation.value.clamp(0.0, 1.0)),
        );
            ...
            children: <Widget>[
              ...
              widget.showTwoGlows
                  ? AnimatedBuilder(
                      ...
                      builder: (context, widget) {
                        final size = smallDiscAnimation.value.clamp(0.0, double.infinity);
