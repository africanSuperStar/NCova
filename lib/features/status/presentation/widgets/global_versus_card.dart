...
class GlobalVersusCard extends StatelessWidget {
  final Status intl;

  GlobalVersusCard({this.intl});
        ...
        children: <Widget>[
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(color: DaintyColors.primary, width: 2),
              boxShadow: <BoxShadow>[
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(color: DaintyColors.primary, fontSize: 24),
                    ),
                  ),
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          ...
                          style: TextStyle(color: DaintyColors.primary, fontSize: 24, fontWeight: FontWeight.w500),
                        ),
                      ],
                    ),
                  ),
